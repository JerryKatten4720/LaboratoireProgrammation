...
namespace LaboratoireProgrammation.Project.Views.Exercices {
    ...
    public partial class Exo___8 : UserControl {
        ...
        private void InitializeStorageDrives() {
            string[] availableDrives = Environment.GetLogicalDrives();
            
            foreach (string drivePath in availableDrives) {
                TreeViewItem driveContainer = new TreeViewItem {
                    Header = drivePath,
                    Tag = drivePath
                };
        ...
        private void HandleDirectoryExpansion(object sender, RoutedEventArgs e) {
            ...
            if (currentContainer == null || currentContainer.Items.Count != 1 || currentContainer.Items[0] != null) {
                return;
            }

            currentContainer.Items.Clear();
            string containerPath = currentContainer.Tag.ToString();
        ...
        private void PopulateSubDirectories(TreeViewItem parentContainer, string targetPath) {
            try {
                ...
                string[] childDirectories = Directory.GetDirectories(targetPath);
                
                foreach (string directoryPath in childDirectories) {
                    DirectoryInfo dirInfo = new DirectoryInfo(directoryPath);
                    TreeViewItem directoryContainer = new TreeViewItem {
                        Header = dirInfo.Name,
                        Tag = directoryPath
                    };
        ...
        private void HandleDirectorySelection(object sender, RoutedPropertyChangedEventArgs<object> e) {
            TreeViewItem selectedContainer = DirectoryTree.SelectedItem as TreeViewItem;
            
            if (selectedContainer != null) {
                string targetPath = selectedContainer.Tag.ToString();
        ...
        private void DisplayFolderAssets(string targetPath) {
            ...
            try {
                ...
                string[] childDirectories = Directory.GetDirectories(targetPath);
                foreach (string dirPath in childDirectories) {
                ...
                foreach (string filePath in targetFiles) {
                    FileInfo assetInfo = new FileInfo(filePath);
                    FileBrowser.Items.Add(new FileSystemEntity {
                ...
                int totalItems = childDirectories.Length + targetFiles.Length;
        ...
        private void HandleViewModeChange(object sender, SelectionChangedEventArgs e) {
            ...
            ComboBoxItem selectedMode = ViewModeSelector.SelectedItem as ComboBoxItem;
            string modeName = selectedMode.Content.ToString();
